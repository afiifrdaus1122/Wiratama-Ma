...
class HeroBannerController extends Controller
{
    ...
    {
        $banners = HeroBanner::orderBy('page')->orderBy('sort_order')->get();
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'desktop_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:4096',
            ...
            'height_vh' => 'nullable|integer|min:10|max:100',
            'is_active' => 'boolean',
        ...
        $validated['cta_target'] = $validated['cta_target'] ?? '_self';
        $validated['height_vh'] = $validated['height_vh'] ?? 80;
    ...
    public function update(Request $request, HeroBanner $heroBanner)
    {
        ...
        $validated['is_active'] = $request->has('is_active');
        $validated['cta_target'] = $validated['cta_target'] ?? $heroBanner->cta_target ?? '_self';
        $validated['height_vh'] = $validated['height_vh'] ?? $heroBanner->height_vh ?? 80;
        $validated['sort_order'] = $validated['sort_order'] ?? $heroBanner->sort_order ?? 0;
