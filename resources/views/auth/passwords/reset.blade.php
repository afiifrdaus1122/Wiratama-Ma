            ...
            <div class="col-md-8 col-lg-5">
                <div class="glass-card p-4 p-md-5">
                    <div class="text-center mb-4">
                        ...
                        <h3 class="fw-bold text-dark mt-4 mb-2">Buat Sandi Baru</h3>
                        <p class="text-muted small mb-0">Silakan masukkan kata sandi baru Anda.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" readonly>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold small text-dark">Kata Sandi Baru</label>
